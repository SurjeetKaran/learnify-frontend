  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] px-4 py-8 animate-fade-in">
      ...
      >
        ...
        {/* Delete section (unchanged) — already in your working version */}
              ...
              {deleteReason && (
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] text-sm focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400"
                  />
                </div>
              )}
